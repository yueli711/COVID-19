...
1. Store the file [24celllines_4patients_norm.txt](https://github.com/yueli8/COVID-19/blob/master/input_files/24celllines_4patients_norm.txt) in the directory ```~/covid19```, run the code [cell24_4patients_25yueli.R](https://github.com/yueli8/COVID-19/blob/master/Normalize_differentially%20expressed%20genes/gse147507_deg.csv)it will generate [cell24_4.csv](https://github.com/yueli8/COVID-19/blob/master/input_files/signature_gene_list_prior_25yueli.csv) during the process.  
