...
1. Generate Table 1 and Figure 1A, B of 25 gene expression signature: cell24_4.csv, it will generate' [24celllines_4patients_norm.txt] (https://github.com/yueli711/COVID-19/blob/master/Table1_Figure1AB_cell24_4/cell24_4.csv) during the process.  
