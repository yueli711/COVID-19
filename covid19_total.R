...
DoHeatmap(subset(Basal,downsample=50000), features = markers.to.plot, size = 5, group.by="tech"，group.colors = c("green3","cornflowerblue","orangered"))
DoHeatmap(subset(Dendritic,downsample=50000), features = markers.to.plot, size = 5, group.by="tech"，group.colors = c("green3","cornflowerblue","orangered"))
DoHeatmap(subset(Macrophage,downsample=50000), features = markers.to.plot, size = 5, group.by="tech"，group.colors = c("green3","cornflowerblue","orangered"))
DoHeatmap(subset(Naive_CD4_T,downsample=50000), features = markers.to.plot, size = 5, group.by="tech"，group.colors = c("green3","cornflowerblue","orangered"))
DoHeatmap(subset(Neutrophils,downsample=50000), features = markers.to.plot, size = 5, group.by="tech"，group.colors = c("green3","cornflowerblue","orangered"))
DoHeatmap(subset(NK,downsample=50000), features = markers.to.plot, size = 5, group.by="tech"，group.colors = c("green3","cornflowerblue","orangered"))
DoHeatmap(subset(Plasma,downsample=50000), features = markers.to.plot, size = 5, group.by="tech"，group.colors = c("green3","cornflowerblue","orangered"))
DoHeatmap(subset(T,downsample=50000), features = markers.to.plot, size = 5, group.by="tech"，group.colors = c("green3","cornflowerblue","orangered"))
